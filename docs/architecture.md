...
| Desktop | [Computer use](../crates/borg-agent-runtime/src/computer_use.rs) dispatches the Linux Rust worker, macOS Swift and Windows PowerShell helpers. Scoped observation, permissions and consequential-action confirmation. [Readiness](computer-use.md). |
